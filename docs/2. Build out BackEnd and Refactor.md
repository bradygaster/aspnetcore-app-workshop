...
In this task, you'll update the **Speakers** control to retrieve speaker information using the composite types you defined in the earlier task.
...
2. Modify the the **GetSpeakers()** method as shown below. The data returned by this method now includes **SessionSpeaker** information, and **Session** information for the **SessionSpeaker** property:
   ...
   While this code will work, it returns the model class directly. A better practice is to return an output model class. This is the approach you'll implement in the next steps.
...
## Add an API Controller and DTOs for managing Attendees

## Add an API Controller and DTOs for managing Sessions
