...
> **Note:** You can either continue with your own solution, or use the code in the [Session 1 save point folder](../save-points/1-Create-API-and-EF-Model/ConferencePlanner).
