...
> **Note:** This task is only necessary if you have prevously been using SQLite to manage the conference database. If you have been using SQL Server, omit this step.
...
4. Execute the following commands to open the SQL Server firewall. Replace *\<your-ip-address\>* with the address of your computer. These commands will allow you to access the server from your computer, and from Azure services, including the **BackEnd** web API service.
    ...
    ```console
    az sql server firewall-rule create --name azure --resource-group aspnetrg --server backendserver<service-name-suffix> --start-ip-address <your-ip-address> --end-ip-address <your-ip-address> 51.137.128.46
...
> **Note:** This task is only necessary if you have prevously been using SQLite to manage the identity database. If you have been using SQL Server, omit this step.
