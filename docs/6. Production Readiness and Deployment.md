...
7. Right-click any of the selected tasks, and the click **Remove selected task(s)**. You should be left with a pipeline containing only the **Use NuGet 5.0.0** task.
