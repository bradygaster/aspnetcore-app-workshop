...
3. In the **Add Identity** dialog, next to the **Data context class** box, click **+**.
...
5. In the **Add Identity** dialog, next to the **User class** box, click **+**.
...
8. On the **Home** page, click **Register**, and create a new account for yourself. Follow the registration process as directed by the application. On the **Register confirmation** page, click **Click here to confirm your account**. You're the first user, so you'll be the administrator.
