...
6. Build and run the solution. On the home page, click the name of any session. On the session details page click te name of any of the speakers. A page will appear displaying the list of sessions presented by the speaker:

    ![The web browser displaying the details of a speaker](images/3-speaker-detals.png)

7. Stop the web application and web API service.

## Add search functionality to the back-end web API service

For the final task in this session, you'll add search functionality to the web API service. Users will be able to search for speakers and sessions.
...
In this task, you'll modify the **FrontEnd** project to allow the user to submit search requests to the **BackEnd**** web API service, and display the results.
...
**TEST AND FINISH OFF TOMORROW**

10. Click on the `Search` link to test the new search feature.
