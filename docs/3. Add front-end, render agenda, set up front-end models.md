...
3. Modify the constructor to take an **IApiClient** object as the parameter, and store this object in a local field, as shown below:
...
4. Remove the **_logger** field as it is no longer used.
...
3. Test the solution:
    ...
    - **If you're using Visual Studio 2019:**
        ...
        2. In the **Solution 'ConferencePlanner' Property Pages** dialog box, select **Multiple startup projects**, set the **Action** for the **BackEnd** and **FrontEnd** projects to **Start**, and then click **OK**.
            ...
            ![The **Property Pages** dialog box for the solution. The user has selected the **BackEnd** and **FrontEnd** projects as startup projects](images/4-solution-properties.png)
...
## Update the sessions list user interface
