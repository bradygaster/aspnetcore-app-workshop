...
6. In the **Reference Manager - FrontEnd** dialog box, on the **Project** tab, select the **ConferenceDTO** project, and then click **OK**.
...
1. In the **FrontEnd** project, in the **Pages** folder, open the **Index.cshtml.cs** file. The **Index.cshtml.cs** file contains the **IndexModel** class.
   ...
   > **Note:** If you're using Visual Studio, expand the **Index.cshtml** file in the **Solution Explorer** window to see the **Index.cshtml.cs** file.
...
3. Test the solution:
    ...
    - **If you're using the .NET Core CLI:**
        ...
        10. Open a web browser, and go to the URL of the **FrontEnd** web application. This will be one of the URLs you specified in the **applicationUrl** property, in the **launchSettings.json** file.

4. Verify that the website displays a list of conference sessions:
...
3. Switch to the **BackEnd** project, and add a new controller, named **SearchController**, to the **Controllers** folder:
    ...
    - **If you're using Visual Studio 2019**:
        1. In the **Solution Explorer** window, right-click the **Controllers** folder in the **BackEnd** project, click **Add**, and then click **Controller**.
